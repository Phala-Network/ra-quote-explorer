  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Report Analysis Results</h1>
        
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Report Overview</CardTitle>
            <CardDescription>Key information about the analyzed report</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center">
                ...
                <span>Timestamp: {new Date(reportData.timestamp).toLocaleString()}</span>
              </div>
              <div className="flex items-center">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="font-mono">{reportData.mrenclave}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>MRSIGNER</TableCell>
                  <TableCell className="font-mono">{reportData.mrsigner}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Report Data</TableCell>
                  <TableCell className="font-mono">{reportData.reportData}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
